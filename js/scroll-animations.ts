...
export function initScrollAnimations(): void {
  ...
  observe(document.getElementById('sobre'), () => {
    ...
    anime({ targets: '.robot-about-right', opacity: [0, 0.10], translateX: [20, 0], duration: 900, easing: 'easeOutExpo', delay: 300 })
    anime({ targets: '.robot-about-left', opacity: [0, 0.10], translateX: [20, 0], duration: 900, easing: 'easeOutExpo', delay: 300 })
  ...
  observe(document.getElementById('diferenciais'), () => {
    ...
    anime({ targets: '.lightning-stats', opacity: [0, 0.10], duration: 1000, easing: 'easeOutCubic', delay: 400 })
    anime({ targets: '.robot-stats-right', opacity: [0, 1], duration: 1000, easing: 'easeOutCubic', delay: 400 })
  }, { threshold: 0.1 })
  // Seção Contato
  observe(document.getElementById('contato'), () => {
    ...
    anime({ targets: '.robot-contact-left', opacity: [0, 1], translateX: [-20, 0], duration: 900, easing: 'easeOutExpo', delay: 300 })
  }, { threshold: 0.1 })
}
